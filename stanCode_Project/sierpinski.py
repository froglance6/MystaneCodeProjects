...
def sierpinski_triangle(order, length, upper_left_x, upper_left_y):
	...
	left_line = GLine(upper_left_x, upper_left_y, upper_left_x + length / 2, upper_left_y + length * 0.866)
	...
	if order == 0:
		...
		sierpinski_triangle(order, length / 2, upper_left_x + length / 4, upper_left_y + length * 0.866 / 2)
		pause(10)
